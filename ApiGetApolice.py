...
if access_token:
    ...
    placaOuChassi = sys.argv[1]
    dataOcorrencia = sys.argv[2]
    numeroDocumentoSegurado = sys.argv[3]

    # URL da API
    url = f"https://apis.com.br/v1/apolices?placaOuChassi={placaOuChassi}&dataOcorrencia={dataOcorrencia}&numeroDocumentoSegurado={numeroDocumentoSegurado}"
